...
Wenn rclone meldet, dass frühere Path-Listings fehlen, startet `nc_pull` automatisch genau einen Recovery-Lauf mit `--resync --resync-mode path1`. Dabei gilt die Cloud-Seite (`REMOTE:` / Path1) als maßgeblich; lokale Abweichungen werden entsprechend überschrieben bzw. abgeglichen.
